    ...
    <v-container v-else fluid>
      <validation-observer ref="observer">
        <form @submit.prevent="submit">
          ...
          <v-btn color="red" dark @click="deleteOrganizationActivity">
  ...
  methods: {
    async getOrganizationActivity() {
      const response = await this.$axios.get(
        '/profile/organizationactivity?id=' + this.$route.params.edit
      )
      this.organizationActivity = response.data
    },
    async deleteOrganizationActivity() {
      if (confirm('Hapus ' + this.organizationActivity.org_name) === true) {
